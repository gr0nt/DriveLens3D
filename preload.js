...
contextBridge.exposeInMainWorld('api', {
  ...
  onMenuSettings:  (cb) => ipcRenderer.on('menu-settings', (_e, v) => cb(v)),
  onMenuAbout:     (cb) => ipcRenderer.on('menu-about',    (_e, v) => cb(v)),
  onMenuHelp:      (cb) => ipcRenderer.on('menu-help',     (_e, v) => cb(v)),
